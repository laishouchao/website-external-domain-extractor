<template>
  <div class="relative group font-mono text-xs bg-slate-950/80 border border-slate-800 rounded-xl p-3 overflow-hidden shadow-inner">
    <div class="overflow-x-auto max-h-36 text-slate-300 leading-relaxed break-all select-all whitespace-pre-wrap">
    ...
    <button
      @click="copyContent"
      class="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition px-2 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 text-[11px] border border-slate-700 flex items-center gap-1 shadow cursor-pointer"
